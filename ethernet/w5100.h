...
#define  W5100_IR_S2_INT                (1<<2)          /* 1 means socket 2 interrup occurred */
#define  W5100_IR_S1_INT                (1<<1)          /* 1 means socket 1 interrup occurred */
#define  W5100_IR_S0_INT                (1<<0)          /* 1 means socket 0 interrup occurred */
...
/*
 *  The ADDRESS_CFG structure holds the target-specific MAC, IP, and gateway addresses,
...
typedef struct  W5100_callbacks_t
{
        ...
        uint8_t                   				(* _xchg)(uint8_t  val);          // function for exchanging a byte with the W5100
 ...
 *
 *  This routine uses the contents of the ADDRESS_CFG structure pointed to by argument
 ...
 */
uint8_t W51_config(ADDRESS_CFG *pcfg);
